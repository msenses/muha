          ...
          <div style={{ padding: 12 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 260px', gap: 12 }}>
              ...
              <aside style={{ display: 'grid', gap: 8, alignContent: 'start' }}>
                ...
                <button onClick={() => router.push((`/accounts/${accountId}/collection/new`) as Route)} style={{ padding: '10px 12px', borderRadius: 8, border: '1px solid #16a085', background: '#16a085', color: 'white', cursor: 'pointer' }}>Cariden Tahsilat Yap</button>
                <button onClick={() => router.push((`/accounts/${accountId}/payment/new`) as Route)} style={{ padding: '10px 12px', borderRadius: 8, border: '1px solid #27ae60', background: '#27ae60', color: 'white', cursor: 'pointer' }}>Cariye Ödeme Yap</button>
                <button onClick={() => router.push((`/accounts/${accountId}/credit/new`) as Route)} style={{ padding: '10px 12px', borderRadius: 8, border: '1px solid #2c3e50', background: '#2c3e50', color: 'white', cursor: 'pointer' }}>Cariyi Alacaklandır</button>
                <button onClick={() => router.push((`/accounts/${accountId}/debt/new`) as Route)} style={{ padding: '10px 12px', borderRadius: 8, border: '1px solid #7f8c8d', background: '#7f8c8d', color: 'white', cursor: 'pointer' }}>Cariye Borçlandır</button>
              </aside>
            </div>
          </div>
        </div>
