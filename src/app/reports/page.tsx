    ...
    <main style={{ minHeight: '100dvh', background: 'linear-gradient(135deg,#0b2161,#0e3aa3)', color: 'white' }}>
      <section style={{ padding: 16 }}>
        <div style={{ padding: 16, borderRadius: 16, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', backdropFilter: 'blur(10px)' }}>
          <div style={{ fontSize: 18, marginBottom: 8 }}>Raporlar</div>
          <div style={{ fontSize: 13, opacity: 0.9 }}>Bu sayfa yakında temel raporlarla (cari ekstre, satışlar, stok hareketi) doldurulacak.</div>
