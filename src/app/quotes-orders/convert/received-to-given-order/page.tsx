  ...
  return (
    <main style={{ minHeight: '100dvh', background: '#ecf0f5', color: '#111827' }}>
      <section style={{ padding: 12 }}>
        ...
        <div style={{ fontWeight: 800, color: '#0f172a' }}>VERİLEN SİPARİŞ</div>
        ...
        >
          ...
          <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, padding: 10, display: 'grid', gap: 6 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr 120px 1fr', gap: 6, alignItems: 'center' }}>
              ...
              <span>Sipariş No</span><input value="VS-001" readOnly style={{ padding: '8px 10px', border: '1px solid #d1d5db', borderRadius: 6, width: '100%' }} />
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 8 }}>
          <button style={{ padding: '10px 16px', borderRadius: 6, border: '1px solid #10b981', background: '#10b981', color: '#fff' }}>Verilen Siparişe Dönüştür</button>
        </div>
      </section>
    </main>
  );
...
export default function ConvertReceivedToGivenOrderPage() {
  return (
