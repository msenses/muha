    ...
    <main style={{ minHeight: '100dvh', background: 'linear-gradient(135deg,#0b2161,#0e3aa3)', color: 'white' }}>
      <header style={{ display: 'grid', gap: 10, padding: 16 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
          ...
          <button onClick={() => router.push('/invoices/new?purchase=1')} style={{ padding: '10px 12px', borderRadius: 8, border: '1px solid #1abc9c', background: '#1abc9c', color: 'white', cursor: 'pointer' }}>Yeni Alış Faturası</button>
          <button disabled style={{ opacity: 0.7, cursor: 'not-allowed', padding: '10px 12px', borderRadius: 8, border: '1px solid #bdc3c7', background: '#bdc3c7', color: '#2c3e50' }}>Satış İrsaliyesi</button>
