        ...
        <form onSubmit={submit} style={{ display: 'grid', gap: 12 }}>
            ...
            <div style={{ padding: 12, borderRadius: 12, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)' }}>
              <div style={{ display: 'flex', gap: 6, alignItems: 'center', marginBottom: 8, flexWrap: 'wrap' }}>
                <button
                  ...
                  style={{ padding: '6px 8px', borderRadius: 6, border: '1px solid rgba(255,255,255,0.2)', background: invoiceTab === 'info' ? 'rgba(255,255,255,0.18)' : 'rgba(255,255,255,0.12)', color: 'white', fontSize: 12 }}
                >
                  Fatura Bilgileri
                </button>
                <button
                  ...
                  style={{ padding: '6px 8px', borderRadius: 6, border: '1px solid rgba(255,255,255,0.2)', background: invoiceTab === 'extra' ? 'rgba(255,255,255,0.18)' : 'rgba(255,255,255,0.12)', color: 'white', fontSize: 12 }}
                >
                  Fatura Ek Alanlar
                </button>
              </div>
                ...
                <div style={{ display: 'grid', gap: 8 }}>
                  ...
                  {eInvoiceMode && (
                    <div style={{ display: 'grid', gap: 6 }}>
                      ...
                      {isEInvoiceFlag && (
                        <div style={{ background: '#16a34a', color: '#fff', padding: '6px 8px', borderRadius: 6, fontWeight: 700, textAlign: 'center', fontSize: 13 }}>
                          E‑FATURA
                        </div>
                      )}
                      <div>
                        <div style={{ fontSize: 11, opacity: 0.8, marginBottom: 2 }}>Para Birimleri :</div>
                        <select value={currency} onChange={(e) => setCurrency(e.target.value as any)} style={{ width: '100%', padding: '6px 8px', borderRadius: 6, border: '1px solid rgba(255,255,255,0.2)', background: 'rgba(0,0,0,0.15)', color: 'white', fontSize: 12 }}>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
                        ...
                        <div>
                          <div style={{ fontSize: 11, opacity: 0.8, marginBottom: 2 }}>Fatura Senaryosu</div>
                  ...
                  <button type="button" onClick={() => setShowSettings(true)} style={{ width: '100%', padding: '8px 10px', borderRadius: 6, border: '1px solid #1e40af', background: '#1e40af', color: 'white', fontWeight: 600, fontSize: 12 }}>
                    Alış Satış Ayarları
                  </button>
                </div>
              ) : (
          ...
          {showAddPanel && (
            <div style={{ marginTop: 8, padding: 10, borderRadius: 10, border: '1px solid rgba(255,255,255,0.12)', background: 'rgba(255,255,255,0.05)' }}>
              ...
              {/* Özel Matrah fatura tipi seçiliyse Tevkifat 801-811 */}
              {invoiceKind === 'OZELMATRAH' && (
                <div style={{ marginTop: 12, padding: 10, borderRadius: 8, border: '1px solid rgba(255,255,255,0.15)', background: 'rgba(255,255,255,0.03)' }}>
                  <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: '#8b5cf6' }}>Özel Matrah Bilgileri</div>
                  <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 8 }}>
                    <div>
                      <div style={{ fontSize: 11, opacity: 0.85, marginBottom: 4 }}>Tevkifat Kodu (801-811)</div>
                      <select value={draftTevkifatDurumu} onChange={(e) => setDraftTevkifatDurumu(e.target.value)} style={{ width: '100%', padding: '6px 8px', borderRadius: 6, border: '1px solid rgba(255,255,255,0.2)', background: 'rgba(0,0,0,0.15)', color: 'white', fontSize: 11 }}>
                        <option value="">Tevkifat Kodu Seçiniz</option>
                  ...
                  <div style={{ fontSize: 10, color: '#cbd5e1', marginTop: 6, lineHeight: '1.3' }}>
                    Özel matrah: Faturadaki ürünlerden herhangi birinde 801-811 arasındaki tevkifat kodları kullanıldığında bu fatura tipi seçilmelidir.
                  </div>
                </div>
              )}
